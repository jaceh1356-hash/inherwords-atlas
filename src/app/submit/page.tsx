...
export default function SubmitPage() {
  return (
    <div style={{ backgroundColor: '#c4b5d6' }}>
      ...
      {/* Benefits Section */}
      <section className="py-8 px-6" style={{ backgroundColor: '#c4b5d6' }}>
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            
            {/* Help Others Feel Less Alone - Left */}
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: '#55a4af' }}>
...
function SimpleShareStoryForm() {
  ...
  return (
    <section className="py-6 px-6" style={{ backgroundColor: '#c4b5d6' }}>
      <div className="max-w-4xl mx-auto">
